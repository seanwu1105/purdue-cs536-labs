/* Created by splite 20 oct 2019, inspired by
 * https://gist.github.com/ghedo/963382 */
/* Adopted for CS536 by park oct 2019 */
/* To compile: gcc -o testaudio testaudio.c -lasound */
/* Usage: example main() code reads from .au audio file given as argv[1] in
   blocks of bufsiz = 4096 bytes and writes to alsa audio device in blocks of
   bufsiz. Betweem successive read/writes code sleeps for slptime microseconds
        given by argv[2]. */
/* Use /usr/bin/aplay on pod machines to check audio quality of pp.au and
   kline-jarrett.au playback without streaming. */
